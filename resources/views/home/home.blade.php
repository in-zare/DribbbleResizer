...
<form id="dropzone" method="POST" action="/resize" enctype="multipart/form-data" class="dropzone">
    ...
    <div class="panel panel-default">
        <div class="panel-body clearfix">
            ...
            <div style="width: 50%;float:right">
                ...
                <input type="text" class="margin-input"  max="200" name="margin" value="0"/>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <label for="r3"><span></span>HEX <input type="text" class="jscolor {onFineChange:'updateBg(this)'}" name="customColor" value="F36E9F"></label>
        </div>
    </div>

    <div class="panel panel-default panel-preview">
        <div class="panel-body clearfix" id="preview-container">
            <div class="bg" id="preview">
